...
export class FuseNavigationComponent implements OnInit
{
  ...
  setNavitaionPermissionWise(token){
        ...
        // Register the navigation to the service
           ...
           var fullNav = JSON.parse(JSON.stringify(navigation));
           this.rearrage_permission(res_permission,fullNav);
           console.log('fullNav',fullNav);
           console.log('userNav',res_permission);
          
           
        //    let user_permission =  JSON.parse(JSON.stringify(res_permission));
            // Register the new navigation
            this._fuseNavigationService.register('user-nav',res_permission);
